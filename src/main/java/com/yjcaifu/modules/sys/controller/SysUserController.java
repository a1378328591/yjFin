...
import com.yjcaifu.common.validator.Assert;
...
import com.yjcaifu.common.validator.group.UpdateGroup;
import com.yjcaifu.modules.sys.entity.SysUserEntity;
import com.yjcaifu.modules.sys.form.PasswordForm;
...
public class SysUserController extends AbstractController {
	...
	public R save(@RequestBody SysUserEntity user){
		...
		//用户信息
		SysUserEntity esist = sysUserService.queryByMobile(user.getMobile());
		if(null!=esist){
	...
	public R update(@RequestBody SysUserEntity user){
		...
		SysUserEntity esist = sysUserService.queryByMobileNoEqualId(params);
		if(null!=esist){
			throw new RRException("手机号已存在");
		}
		user.setCreateUserId(getUserId());
